...
- 2026-09-15 — Phase 2: enquiries + personal links (SCHEMA: `DriftShareLink` → db push). Page settings → "Enquiry
  ...
  stored as a lead, emailed to Admins + Editors (reply goes to the visitor, "See all enquiries" link), listed under
  "Enquiries" on the page (Editors + Admins; Admins can delete). Share sheet → "Send it to someone": a personal link per
