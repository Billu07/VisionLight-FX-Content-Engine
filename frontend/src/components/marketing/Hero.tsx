    ...
    <>
      <div className="relative min-h-screen overflow-hidden bg-[#070a20] text-white">
        ...
        <main className="relative z-10">
          <section className="mx-auto grid w-full max-w-7xl gap-10 px-4 pb-14 pt-12 sm:px-6 lg:grid-cols-[1fr_1.2fr] lg:pt-14">
          ...
          <section className="mx-auto grid w-full max-w-7xl gap-8 px-4 pb-16 pt-10 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:pt-8">
            <div className="relative lg:-mt-4 [perspective:1800px]">
