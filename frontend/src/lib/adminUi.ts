export const adminUi = {
  loading:
    "min-h-screen bg-[#070a20] flex items-center justify-center text-gray-200",
  page:
    "relative min-h-screen overflow-hidden bg-[#070a20] px-4 py-6 text-gray-200 sm:px-6 lg:px-8",
  backdrop:
    "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_14%_10%,rgba(34,211,238,0.14),transparent_36%),radial-gradient(circle_at_82%_12%,rgba(56,189,248,0.14),transparent_44%)]",
  container: "relative mx-auto w-full max-w-7xl pb-24",
  header:
  ...
  metricCard:
    "rounded-2xl border border-white/10 bg-white/[0.045] p-4 shadow-[0_18px_42px_rgba(2,8,23,0.28)] backdrop-blur-xl",
  ...
  amberButton:
    "rounded-lg border border-amber-400/25 bg-amber-400/10 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.14em] text-amber-300 transition-colors hover:bg-amber-400/15 hover:text-amber-100 disabled:cursor-not-allowed disabled:opacity-40",
  dangerButton:
