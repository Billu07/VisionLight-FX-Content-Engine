...
import { DriftTerms } from "../rotation3d/DriftLegal";

export const Terms = () => {
  // drift.li (and brand custom domains) publish the Drift Link agreement, not the studio's.
  if (isDriftSite()) return <DriftTerms />;
  return (
