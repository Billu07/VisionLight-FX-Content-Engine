...
import { isDriftLegal, legalBrand } from "../lib/legalBrand";

export const Terms = () => {
  const b = legalBrand();
  const drift = isDriftLegal();
  return (
    <div className={`min-h-screen bg-gradient-to-br ${b.shell} font-sans`}>
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="bg-gray-900/60 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/10 shadow-2xl space-y-10 text-gray-300 leading-relaxed">
          <p className={`italic text-lg ${b.intro}`}>
            These Terms and Conditions (the "Agreement") govern your use of
            {b.product}, a platform created and operated by Visionlight
            Production Inc. ("we," "us," or "our"). By accessing or using
            {b.engineLong}, you agree to be bound by
            this Agreement.
          </p>
          ...
          <section>
            ...
            {drift ? (
              <p>
                Drift Link is a creative platform that turns short video clips
                into interactive "drift" paths people scrub with a finger, and
                lets creators and brands connect them with headlines, captions
                and buttons into tours and campaigns. Our engine processes
                uploaded footage into frame sequences and hosts the resulting
                players.
              </p>
            ) : (
              <p>
                {b.product} is a creative platform that allows users to
          ...
          <section>
            ...
            <p className="mb-2">
              ...
              make no guarantee that {b.platformOrEngine} will operate without
          ...
          <section>
            ...
            <p className="mb-2">By using {b.product}, you agree to:</p>
            <ul className="list-disc pl-5 space-y-2 mb-4">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                All proprietary technology, including {b.engineTech},
          ...
          <section>
            ...
            <p className="mb-2">
              {b.platformAndEngine} are provided "as is" and "as available"
          ...
          <section>
            ...
            <p>
              By creating an account or using {b.product}, you acknowledge
          ...
          <section>
            ...
            <p className="mb-4">
              To use rendering features within {b.product} and the FX
          ...
          <section>
            ...
            <p>We process data only as necessary to operate {b.product}.</p>
          </section>
          ...
          <section>
            ...
            <p>
              {b.product} is not intended for children under 13. If we
