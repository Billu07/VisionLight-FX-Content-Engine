...
export const MAIL_TEMPLATES: MailTemplateDef[] = [
  ...
  },
  {
    ...
    vars: [
      ...
      { name: "roleLabel", description: "The role they're invited as", sample: "an Editor" },
      { name: "roleSummary", description: "What that role can do", sample: "build and publish its Drift Tours" },
    ],
    defaults: f({
      subject: "{{inviterLabel}} invited you to {{pageName}} on drift.li",
      heading: "You're invited to a page on drift.li",
      intro:
        '{{inviterLabel}} invited you to "{{pageName}}" as {{roleLabel}} — you\'ll be able to {{roleSummary}}. A short pan or tilt of each space becomes an interactive tour.',
  ...
  },
  {
    ...
    vars: [
      ...
      { name: "roleLabel", description: "The role they joined as", sample: "an Editor" },
    ],
    defaults: f({
      subject: "{{proLabel}} joined {{pageName}} on drift.li",
      heading: "Someone joined your page",
      intro: '{{proLabel}} accepted your invite and joined "{{pageName}}" as {{roleLabel}}.',
  ...
  {
    key: "tour.enquiry.new",
    name: "Tour enquiry",
    description: "Sent when a visitor uses a tour page's enquiry button (e.g. Book a viewing). Their details are listed under the intro; replying goes straight to them.",
    trigger: "A visitor sends an enquiry from a page, tour or drift",
    audience: "The page's Admins and Editors",
    vars: [
      { name: "pageName", description: "The page", sample: "Harbour Homes" },
      { name: "button", description: "The button they used", sample: "Book a viewing" },
      { name: "visitorName", description: "Their name", sample: "Jane Doe" },
      { name: "visitorEmail", description: "Their email", sample: "jane@example.com" },
      { name: "tourName", description: "The tour they were in (may be empty)", sample: "45 Birch" },
      { name: "viaLine", description: "A line naming the personal link, or empty", sample: "They opened the link you sent to Sam Carter." },
      { name: "url", description: "The page's enquiries", sample: "https://drift.li/tour/harbour-homes?enquiries=1" },
    ],
    defaults: f({
      subject: "{{button}}: {{visitorName}}",
      heading: "New enquiry for {{pageName}}",
      intro: "{{visitorName}} ({{visitorEmail}}) sent you a message. {{viaLine}} Reply to this email to answer them.",
      ctaLabel: "See all enquiries",
      ctaUrl: "{{url}}",
      footnote: "Sent to the admins and editors of this drift.li page.",
    }),
  },
  {
